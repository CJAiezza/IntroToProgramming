...
#I took the iris data set, hence renaming it "flower".
flower = [5.1, 3.5, 1.4, 0.2]

sys.stdout.write("Find a flower, measure it and write in cms with an integer below. e.g. 18.0 or 6.3: ")
...
#scratch that! I figured it out! I can't figure out why "None" is displayed instead of the user's inputted integer.
#sys.stdout.write("According to the information you provided, you are, " +firstname+ " " +surname+ ", aged "+str(value)+ ", can speak " +lang+" and picked a flower that is " +str(userinput)+" tall.\n")
#sys.stdin.readline()
